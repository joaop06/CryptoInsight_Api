...
export class RiskClassificationDto {
  ...
  @ApiProperty({ example: 61000.0, description: 'Valor de baixa' })
  low: number;

  @IsNumber()
  @IsNotEmpty({ message: 'Informe a alta do período' })
  @ApiProperty({ example: 63500.0, description: 'Valor de alta' })
  high: number;

  @IsNumber()
  @IsNotEmpty({ message: 'Informe a abertura do período' })
  @ApiProperty({ example: 62000.0, description: 'Valor de abertura' })
  open: number;

  @IsNumber()
  @IsNotEmpty({ message: 'Informe o fechamento do período' })
  @ApiProperty({ example: 62800.0, description: 'Valor de fechamento' })
  close: number;
